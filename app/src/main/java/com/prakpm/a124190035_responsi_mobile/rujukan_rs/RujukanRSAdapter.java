...
public class RujukanRSAdapter extends RecyclerView.Adapter<RujukanRSAdapter.ViewHolder> {

    private ArrayList<DataItem> rumahSakitList = new ArrayList<>();
    private Context context;
    public RujukanRSAdapter(Context context){
...
//        }
        ...
        public ViewHolder(View view) {
            super(view);
            alamatRS = (TextView) view.findViewById(R.id.tv_alamatRS);
            namaRS = (TextView) view.findViewById(R.id.tv_RumahSakit);
